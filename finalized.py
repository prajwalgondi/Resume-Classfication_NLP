...
model = pickle.load(open(r'C:\Users\LENOVO\Documents\excelr projects\Resume classification\trained_model.pkl', 'rb'))
vectorizer = pickle.load(
    open(r'C:\Users\LENOVO\Documents\excelr projects\Resume classification\tfidf_vectorizer.pkl', 'rb'))

# Define the resume_dic mapping dictionary
resume_dict = {0: 'PeopleSoft Resume', 1: 'React JS Developer Resume', 2: 'SQL Developer Lightning Insight Resume',
               3: 'Workday Resume'}
...
if resume_file is not None:
    ...
    #5wordcloud = word_cloud(resume_text)
